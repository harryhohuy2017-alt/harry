...
selectHotbarSlot(0);
globalThis.gameCommandContext={hasBlockType:type=>Object.prototype.hasOwnProperty.call(blocks,type),setBlock:(x,y,z,type)=>{setBlock(x,y,z,type);rebuildWorld();const m=meshes.get(key(x,y,z));if(m){m.scale.set(.15,.15,.15);startAction('place',m,m.position)}updateTarget()}};
